...
class Harmony(object):
    ...
    def init_cluster(self):
        ...
        km = kmeans2(self.Z_cos.T, self.K, iter=10)
        self.Y = km[0].T
        # (1) Normalize
...
def harmony_integrate_mod(
    ...
    **kwargs,
    ...
    harmony_out = run_harmony_mod(adata.obsm[basis], adata.obs, key, **kwargs)
